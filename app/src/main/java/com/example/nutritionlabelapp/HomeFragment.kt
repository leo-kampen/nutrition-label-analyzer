...
//                    // extra padding above the nav (in dp):
//                    val extraDp = 16
//                    val extraPx = (extraDp * resources.displayMetrics.density).toInt()
//
//                    // update the button’s bottom margin
...
//        )
//
//        // Build quiz questions + add “Anything else” as the last question
...
//            ), multiSelect = false),
//            // QUESTION 7: Only “No” option; adapter will auto-add “Other” as your “Yes → free-form”
...
//            // Enable Submit if every single-select has an answer
//            // and every multi-select has at least one, including any “Other”
...
//        }
//
//        // Submit → build payload including each question’s otherText as needed
